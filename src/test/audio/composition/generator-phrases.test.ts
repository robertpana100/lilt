...
import { modalDegreeForPitch, voiceLuteChords } from "@/audio/composition/chords";
import { generateMusicPiece, type MusicCourseEvent, type MusicSection } from "@/audio/composition/generator";
import { createPhrase } from "@/audio/composition/phrase";
import { createMusicRandom } from "@/audio/composition/random";
import { MUSIC_ROOTS, PULSES_PER_QUARTER, getMusicRoot, pulsesPerBar } from "@/audio/composition/roots";
